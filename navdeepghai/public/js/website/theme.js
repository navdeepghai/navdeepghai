...
theme.Sections = function Sections() {
  ...
  $(document)
    .on('navdeepghai:section:load', this._onSectionLoad.bind(this))
    .on('navdeepghai:section:unload', this._onSectionUnload.bind(this))
    .on('navdeepghai:section:select', this._onSelect.bind(this))
    .on('navdeepghai:section:deselect', this._onDeselect.bind(this))
    .on('navdeepghai:block:select', this._onBlockSelect.bind(this))
    .on('navdeepghai:block:deselect', this._onBlockDeselect.bind(this));
};
...
theme.Images = (function() {
   ...
   * @param {String} size - A navdeepghai image size attribute
   */
  ...
  /**
   * +++ Useful
   * Find the navdeepghai image attribute size
   *
   * @param {string} src
   * @returns {null}
   */
  ...
  /**
   * +++ Useful
   * Adds a navdeepghai size attribute to a URL
   *
   * @param src
   * @param size
   * @returns {*}
...
this.navdeepghai = this.navdeepghai || {};
this.navdeepghai.theme = this.navdeepghai.theme || {};
this.navdeepghai.theme.PredictiveSearch = (function() {
  'use strict';
...
this.navdeepghai = this.navdeepghai || {};
this.navdeepghai.theme = this.navdeepghai.theme || {};
this.navdeepghai.theme.PredictiveSearchComponent = (function(PredictiveSearch) {
  'use strict';
...
})(navdeepghai.theme.PredictiveSearch);
...
theme.LibraryLoader = (function() {
  ...
  var libraries = {
    ...
    plyrnavdeepghaiStyles: {
      tagId: 'plyr-navdeepghai-styles',
      src: cloudCdn + 'navdeepghai-plyr/v1.0/navdeepghai-plyr.css',
      type: types.link
    },
    modelViewerUiStyles: {
      tagId: 'navdeepghai-model-viewer-ui-styles',
...
theme.MobileNav = (function() {
  ...
  function cacheSelectors() {
    cache = {
      ...
      $mobileNav: $('#MobileNav'),
      $sectionHeader: $('#navdeepghai-section-header'),
  ...
  function goToSubnav(target) {
    /*eslint-disable navdeepghai/jquery-dollar-sign-reference */
    ...
    /*eslint-enable navdeepghai/jquery-dollar-sign-reference */
...
theme.Slideshow = (function() {
  ...
  function slideshow(el, sectionId) {
    ...
    this.settings = {
      ...
      // eslint-disable-next-line navdeepghai/jquery-dollar-sign-reference
...
theme.Video = (function() {
  ...
  function toggleExpandVideo(playerId, expand) {
    ...
    if (expand) {
      ...
      if (!(isMobile() && navdeepghai.designMode)) {
        $('html, body').animate(
          {
...
theme.ProductVideo = (function() {
  ...
  function init(videoContainer, sectionId) {
    ...
    switch (video.host) {
      case hosts.html5:
        window.navdeepghai.loadFeatures([
          {
            name: 'video-ui',
            version: '1.0',
        ...
        theme.LibraryLoader.load('plyrnavdeepghaiStyles');
        break;
      case hosts.youtube:
  ...
  function createPlayer(video) {
    ...
    switch (video.host) {
      case hosts.html5:
        ...
        video.player = new navdeepghai.Plyr(video.element, {
...
theme.ProductModel = (function() {
  ...
  function setupnavdeepghaiXr(errors) {
    if (errors) return;

    if (!window.navdeepghaiXR) {
      document.addEventListener('navdeepghai_xr_initialized', function() {
        setupnavdeepghaiXr();
      });
      return;
    }
    ...
    for (var sectionId in modelJsonSections) {
      if (modelJsonSections.hasOwnProperty(sectionId)) {
        ...
        window.navdeepghaiXR.addModels(JSON.parse($modelJson.html()));
        modelSection.loaded = true;
      }
    }
    window.navdeepghaiXR.setupXRElements();
  }
    ...
    for (var key in models) {
      if (models.hasOwnProperty(key)) {
        ...
        if (!model.modelViewerUi) {
          model.modelViewerUi = new navdeepghai.ModelViewerUI(model.$element);
        }
  ...
  function setupModelViewerListeners(model) {
    ...
    model.$container.on('mediaVisible', function() {
      xrButton.$element.attr('data-navdeepghai-model3d-id', model.modelId);
      if (theme.Helpers.isTouch()) return;
    ...
    model.$container
      .on('mediaHidden', function() {
        xrButton.$element.attr('data-navdeepghai-model3d-id', xrButton.defaultId);
...
theme.Hero = (function() {
  ...
  function hero(el, sectionId) {
    ...
    var $parentSection = $('#navdeepghai-section-' + sectionId);
...
(function() {
  ...
  function isPredictiveSearchSupported() {
    var navdeepghaiFeatures = JSON.parse($('#navdeepghai-features').text());

    return navdeepghaiFeatures.predictiveSearch;
  }
  ...
  window.theme.SearchPage = (function() {
    ...
    function init(config) {
      componentInstance = new window.navdeepghai.theme.PredictiveSearchComponent({
        selectors: {
...
theme.customerTemplates = (function() {
  ...
  function customerAddressForm() {
    ...
    // Initialize observers on address selectors, defined in navdeepghai_common.js
    if (navdeepghai) {
      // eslint-disable-next-line no-new
      new navdeepghai.CountryProvinceSelector(
        'AddressCountryNew',
        'AddressProvinceNew',
        {
    ...
    $('.address-country-option').each(function() {
      ...
      // eslint-disable-next-line no-new
      new navdeepghai.CountryProvinceSelector(countrySelector, provinceSelector, {
...
theme.Product = (function() {
  function Product(container) {
    ...
    this.selectors = {
      ...
      navdeepghaiPaymentButton: '.navdeepghai-payment-button',
    ...
    this.$navdeepghaiPaymentButton = $(
      this.selectors.navdeepghaiPaymentButton,
      $container
    );
  ...
  Product.prototype = _.assignIn({}, Product.prototype, {
    ...
    _initnavdeepghaiXrLaunch: function() {
      var self = this;
      $(document).on('navdeepghai_xr_launch', function() {
        var $currentMedia = $(
    ...
    _handleButtonLoadingState: function(isLoading) {
      if (isLoading) {
        ...
        this.$navdeepghaiPaymentButton.attr('disabled', true);
        this.$loaderStatus.attr('aria-hidden', false);
      } else {
        this.$addToCart.removeAttr('aria-disabled');
        this.$addToCartText.removeClass(this.classes.hidden);
        this.$loader.addClass(this.classes.hidden);
        this.$navdeepghaiPaymentButton.removeAttr('disabled');
