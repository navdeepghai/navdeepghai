...
import '../../../../../../frappe/frappe/public/js/frappe/ui/field_group';
import '../../../../../../frappe/frappe/public/js/frappe/dom';
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h3 class="modal-title text-center" style="font-weight: bold;">${title}</h3>
					<div class="text-right germbusters-buttons buttons">
						<button type="button" class="btn btn-secondary btn-default btn-sm btn-modal-close" data-dismiss="modal">
...
frappe.ui.Dialog  = class Dialog {
    constructor(opts){
		return new rappe.ui.GDialog(opts);
	}
}


frappe.ui.GDialog = class GermbustersDialog extends frappe.ui.FieldGroup {
	constructor(opts) {
		super();
		this.display = false;
		this.is_dialog = true;
